...
abstract class BaseActivity<ViewBinding : ViewDataBinding, ViewModel : BaseViewModel> :
    ...
    private fun applyTheme() {
        ...
        when (sharedPreferences.getString(ThemeHelper.THEME_PREF, ThemeHelper.COLOR_1)
            ?: ThemeHelper.COLOR_1) {
        ...
        when (sharedPreferences.getString(ThemeHelper.THEME_MODE_PREF, ThemeHelper.DEFAULT_MODE)
