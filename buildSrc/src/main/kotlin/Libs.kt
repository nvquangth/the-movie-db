object Libs {
    ...
    const val lifecycleProcessorJava8 = "androidx.lifecycle:lifecycle-common-java8:${Versions.lifecycle}"
    ...
    // Keyboard listener
    const val keyboardListener = "net.yslibrary.keyboardvisibilityevent:keyboardvisibilityevent:${Versions.keyboardListener}"
}